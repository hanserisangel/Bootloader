...
#define MCU_FLASH_A_START_PAGE      2U      // A 区从第 2 页开始
...
typedef struct{
  ...
  uint8_t OTA_version[32]; // OTA 版本号，字符串数组，格式: version-1.0_2026-02-05_12.00
}OTA_Info_t;
...
typedef struct{
  uint8_t UpAppBuffer[UPDATA_BUFF]; // 一次写入应用程序大小
